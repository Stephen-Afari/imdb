...
export default async function MoviePage({params}) {
  ...
  return (
    ...
    <Image src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.poster_path}`} width={500} height={300} alt='Movie poster'
        ...
        <div className='p-2'>
            ...
            <p className='text-lg mb-3'>
                <span className='font-semibold mr-4'>Overview:</span>{movie.overview}
            </p>
